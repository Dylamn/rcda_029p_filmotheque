...
public class MovieServiceMock implements MovieService {
    // Static attributes managing the values to display
    ...
    private static final String[] genres = {
            "Animation", "Science-fiction", "Documentaire", "Action", "Comédie", "Drame"
    };
    ...
    public MovieServiceMock() {
        ...
        // 2 actors per film and on of them in two films
        ...
        jurassicPark.setProducer(stevenSpielberg);
        ...
        theFly.setProducer(davidCronenberg);
        ...
        theBFG.setProducer(stevenSpielberg);
